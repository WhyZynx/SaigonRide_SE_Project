    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OtpCode = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentityNumber = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IdentityImageUrl = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IdentityType = table.Column<string>(type: "longtext", nullable: false, defaultValue: "None")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PassportStatus = table.Column<string>(type: "longtext", nullable: false, defaultValue: "Pending")
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0m, "admin@saigonride.com", "System Admin", "", "000000000", "CCCD", false, true, "Approved", "$2a$11$DnacZXz2maqH/qAao7xBIuE.ZgAGnEDuX38BOalsGaG4uoBYXSeVK", "Admin", "Local" },
                    { 2, 500000m, "nguyenvana@gmail.com", "Nguyen Van A", null, null, "None", false, true, "Pending", "$2a$11$wE1LdKS2FL/yAAa2pRIkZ.6UrtbRr0znW1EtVKw6DRH4Urlr5kIxu", "User", "Local" },
                    { 3, 300000m, "tranthib@gmail.com", "Tran Thi B", null, null, "None", false, true, "Pending", "$2a$11$q.j1l7l5hHTmLkEH/zURMO6gQYWK4VgJ2VBFiJfQbGGyMXFxTL3ei", "User", "Local" },
                    { 4, 1000000m, "johnsmith@gmail.com", "John Smith", null, null, "None", false, true, "Pending", "$2a$11$xy6V80EfvRKsgwyXPiC09OHj3U0moZl5U2xnhkUWu49Jj5DEwdd.y", "User", "Tourist" },
                    { 5, 800000m, "emilybrown@gmail.com", "Emily Brown", null, null, "None", false, true, "Pending", "$2a$11$vhCo5.bbE3RQYFOjvXLtVe88KpcvOYsI3fcrYp.gNtmW20dW3K94a", "User", "Tourist" }
                });
